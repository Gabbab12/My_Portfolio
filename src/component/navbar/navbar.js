    ...
    return(
        <nav className='navbar'>
            ...
            <div className='desktopMenu'>
                ...
                <Link activeClass='active' to='works' spy={true} smooth={true} offset={-20} duration={500} className='desktopMenuListItem'>Portfolio</Link>
                <Link activeClass='active' to='clients' spy={true} smooth={true} offset={-20} duration={500} className='desktopMenuListItem'>Client</Link>
            </div>
            ...
            <div className='navMenu' style={{display :showMenu? 'flex':'none '} }>
                ...
                <Link activeClass='active' to='clients' spy={true} smooth={true} offset={-20} duration={500} className='listItem' onClick={() =>setShowMenu(false)}>Client</Link>
